...
<title>Sakura Website | 确认订单</title>
...
<body>
	...
	<div
		...
		<p>
			<img class="img" src="img/createOrder.jpg" style="margin-left: 110px" />
			<b style="margin-left: 30px; vertical-align: sub;">收货地址</b>
		</p>
	</div>
	...
	<form action="#">
				...
				<div class="car-btn-group">
					...
					<div class="car-btn-row">
						<input type="button" class="btn-car btn-car-to-pay"
							onclick="if(confirm('确定要修改该地址吗？')){window.location.href=''}"
							value="修改该地址" />
					</div>
				</div>
			</div>
		...
		<div
			style=" width: 100%; float: left; font-size: xx-large; line-height: 10px">
			<p>
				<img class="img" src="img/createOrder.jpg"
					style="margin-left: 110px" /> <b
					style="margin-left: 30px; vertical-align: sub;">订单详情</b>
			</p>
		</div>
		...
		<div class="add-info-box-container"
			...
			<div>
		<div class="add-info-box" style="padding-bottom: 0px; padding-top: 20px;">
			订单号：15646841
		</div>
		<div class="add-info-box"
		...
		<div class="result">
			...
			</b> <input class="btn btn-danger" type="submit" value="确认订单"
