...
<head>
	...
	<style>
		*{
		...
		body{
			background-image: url(img/logSa.jpg);
		}
		#container{
			width: 400px;
			height: 300px;
...
<body>
	...
	<div id="container" >
		...
		<div class="form-body">
			<form action="LogServlet" method="post" name="loginForm">
				<div class="form-group">
					<img class="form-icon" src="img/icon_user.png"/>
					<label for="">手机号：</label>
					<input type="text" class="form-input" id="bindingnumber" name="bindingnumber">
				</div>
				<div class="form-group">
			...
			<div class="btn">
				...
				<input type="button" value="注册账号" class="form-btn form-btn-primary" onclick="window.location.href='signup.jsp'">
			</div>
			</form>
		</div>
...
<script>
	...
	function login()
	{
		...
		var bindingnumber=document.getElementById("bindingnumber").value;
		var password=document.getElementById("password").value;
		if (bindingnumber.length == 0) {
			alert("请输入手机号！")
			return false;
		}
