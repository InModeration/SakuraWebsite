...
<c:if test="${sessionScope.merchant==null }">
	<jsp:forward page="merchantLog.jsp"></jsp:forward>
</c:if>
<!DOCTYPE html>
<html lang="en">
...
<head>
<meta charset="UTF-8">
<title>Sakura Website | 店铺名称</title>
...
<body class="search-page" style="background-color: mistyrose;">
	...
	<div class="nav headInfo">
		<ul>
			...
			<li><a href="#" style="margin-left: 100px;">Sakura首页</a></li>
			<li><a href="#">手机商城</a></li>
			<li><a href="help.html">客户服务</a></li>
			<li><a href="#">企业采购</a></li>
			<li><a href="#">商城会员</a></li>
			<li class="login-signup nav-pull-down my-shop"
				style="padding-top: 0px; margin-left: 300px;">欢迎&nbsp,&nbsp&nbsp<a
				href=>${sessionScope.merchant.vendorName }</a> <span
	...
	<div class="search searchFrame" style="width: 100%">
		<div class="search-body" style="width: 100%">
			<div class="input-group" style="width: 100%">
				<form action="ShowCommodityForMerchantServlet">
					<input type="text" class="form-control" placeholder="在店铺中搜索你想要的商品"
			...
			<div class="item-list-right"
				...
				<div class="item-container">
					...
					<c:if test="${requestScope.resultList!=null }">
						<c:forEach var="commodityInfo" items="${requestScope.resultList }">
							<a href="ShowDetailServlet?commodityNumber=${commodityInfo.commodityNumber }">
								<div class="item-show-info">
									<div class="item-show-img">
										<img src="./${commodityInfo.commodityPictureIndex }1.jpg" width="100%">
									</div>
									<div class="item-show-price">
										<span>
											<i class="fa fa-rmb text-danger"></i>
											<span class="seckill-price text-danger">￥${commodityInfo.commodityPrice }</span>
										</span>
									</div>
