...
<head>
	<meta charset="UTF-8">
	<title>Sakura Website | 管理员登录</title>
	...
	<style>
		*{
		...
		body{
			background-image: url(img/adminLog.jpg);
		}
		#container{
			width: 400px;
			height: 300px;
		...
		<div class="form-body">
			<form action="" method="" name="">
				<div class="form-group">
					...
					<input type="text" class="form-input" id="adminID" name="adminID">
				</div>
				<div class="form-group">
			...
			<div class="btn" >
				<input type="button" value="登陆" class="form-btn form-btn-primary" id="submitbut" onclick="login()">
			</div>
			</form>
		</div>
