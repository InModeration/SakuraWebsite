...
<body>
	...
	<div class="nav headInfo">
		<ul>
			...
			<li class="login-signup nav-pull-down my-shop"
				style="padding-top: 5px; margin-left: 300px;"><img src="img/merchant.jfif" style="width:20px" alt="商家图片"><a
				href=>店铺名</a><span
				...
				<div>
					<a href="#">
							<input type="button" class="btn btn-danger"
								style="margin-top: 8px; margin-left: 30px" value="商品信息修改"
								onclick="window.location.href=''"></a> 
					<a href="#">
							<input type="button" class="btn btn-danger"
								style="margin-top: 8px; margin-left: 40px" value="商品下架"
	...
	<div class="my-shop-panel">
		<p>
			<span class="my-item">进入店铺</span>
			<span class="my-item">&nbsp;&nbsp;&nbsp;订单管理</span>
		</p>
		<p>
			<span class="my-item">商品管理</span>	
			<span class="my-item">&nbsp;&nbsp;&nbsp;店铺管理</span>
		</p>	
		<p>
